...
int main(int argc,char **argv)
{
    ...
    ros::NodeHandle n;
    ros::Publisher keycmdPub=n.advertise<vans_copter::Command>("/ROTORS_1st_PLATFORM/ROTORS_1st/Keycmd",1);
    ros::Publisher CamParamPub=n.advertise<vans_copter::CamParam>("/ROTORS_1st_PLATFORM/ROTORS_1st/CamParam",1);
